...
public class MapClientActivity extends AppCompatActivity implements OnMapReadyCallback {
                ...
                if (getApplicationContext() != null) {
                   ...
                   /* if (mMarker != null) {
                    ...
                    mMarker = mMap.addMarker(new MarkerOptions().position(
                                    ...
                                    .title("Tu posición")
                                    .icon(BitmapDescriptorFactory.fromResource(R.drawable.icons8_persona_30))
                    );*/
    ...
    private void requestDriver() {
        if(mOriginLatLng != null && mDestLatLng !=null){
            ...
            intent.putExtra("dest_lng", mDestLatLng.longitude);
            intent.putExtra("origin", mOriginName);
            intent.putExtra("destination", mDestName);

            startActivity(intent);
        }else{
            Toast.makeText(this, "Seleccione ambos", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void instanceAutoCompleteOrigin() {
        ...
        mAutocomplete.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(@NonNull Place place) {
                mOriginName = place.getName();
                mOriginLatLng = place.getLatLng();
                // Log.d("Place", "Name"+mOriginName);
            }
        });
    ...
    private void instanceAutoCompleteDest() {
        mAutocompleteDest = (AutocompleteSupportFragment) getSupportFragmentManager().findFragmentById(R.id.placeAutocompleteDestination);
        mAutocompleteDest.setPlaceFields(Arrays.asList(Place.Field.ID, Place.Field.LAT_LNG, Place.Field.NAME));
        mAutocompleteDest.setHint("Destino");
        mAutocompleteDest.setCountry("MEX");
        ...
        mGeoFireProvider.getActiveDrivers(mCurrentLatLng).addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                ...
                Marker marker = mMap.addMarker(
                        new MarkerOptions().position(driverLatLng).title("Conductor disponible")
